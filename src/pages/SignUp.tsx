        ...
        >
          <div className="bg-white rounded-3xl p-6 shadow-xl border border-white/20">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-sm">Join Hirebuddy and accelerate your career</p>
            </div>

            {error && (
              <Alert variant="destructive" className="mb-4 bg-red-50/80 backdrop-blur-sm border-red-200/50">
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-[#fcdfe6] to-[#fcdfe6]/50 rounded-xl border border-[#feb7b7]/30">
            ...
            <div className="mt-6 text-center text-sm">
              <p className="text-gray-600">
                ...
                <Link to="/signin" className="text-[#dc425d] font-medium hover:underline">
                  Sign in
                </Link>
              </p>
            </div>
          ...
          <div className="mt-6 bg-white/80 rounded-2xl p-4 shadow-lg border border-white/20">
            <h3 className="font-semibold text-gray-900 mb-3 text-sm">Why join Hirebuddy?</h3>
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                <div className="w-5 h-5 rounded-full bg-[#fcdfe6] flex items-center justify-center mt-0.5">
                  <div className="w-2 h-2 bg-[#f78f97] rounded-full"></div>
                </div>
                <p className="text-xs text-gray-700">AI-powered job matching that finds opportunities tailored to your skills</p>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-5 h-5 rounded-full bg-[#fcdfe6] flex items-center justify-center mt-0.5">
                  <div className="w-2 h-2 bg-[#f78f97] rounded-full"></div>
                </div>
                <p className="text-xs text-gray-700">Automated application tracking to never miss a follow-up</p>
              </div>
              <div className="flex items-start gap-2">
                <div className="w-5 h-5 rounded-full bg-[#fcdfe6] flex items-center justify-center mt-0.5">
                  <div className="w-2 h-2 bg-[#f78f97] rounded-full"></div>
                </div>
                <p className="text-xs text-gray-700">Interview preparation with AI coaching and feedback</p>
              </div>
            </div>
          </div>
        </motion.div>
          ...
          <div className="w-full max-w-md relative">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 animate-slideIn hover:shadow-[#feb7b7]/30 transition-all duration-500">
              <div className="text-center mb-8 animate-fadeIn">
                <h2 className="text-3xl font-bold text-gray-900 mb-2 hover:text-[#dc425d] transition-colors duration-300">Create Your Account</h2>
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <span className="font-medium group-hover:text-blue-600 transition-colors duration-300">Sign up with GitHub</span>
                  </div>
                </Button>
              </div>
