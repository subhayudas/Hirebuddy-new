        ...
        >
          <div className="bg-white rounded-3xl p-6 shadow-xl border border-white/20">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-sm">Sign in to continue your career journey</p>
            </div>
            ...
            <div className="mt-6 text-center text-sm">
              <p className="text-gray-600">
                ...
                <Link to="/signup" className="text-[#dc425d] font-medium hover:underline">
                  Sign up
                </Link>
              </p>
            </div>
