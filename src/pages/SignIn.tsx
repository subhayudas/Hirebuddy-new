        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="mb-8">
            ...
            <h2 className="text-5xl font-bold leading-tight mb-6">
              Ensure a Fast and
              <br />
              <span className="text-orange-200">Successful Journey</span> to
              <br />
            ...
            <div className="space-y-4 text-orange-100">
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg">2X More Qualified Job Matches</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-orange-200 rounded-full"></div>
                <span className="text-lg">60% Time Savings in Job Searches</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-orange-200 rounded-full"></div>
                <span className="text-lg">50% More Interview Invites</span>
              </div>
            </div>
          </div>
        </div>
